...
GRAFITEFLAGS  = -ftree-loop-linear -floop-strip-mine -fgraphite-identity -floop-parallelize-all -floop-interchange -ftree-loop-distribution -floop-block -funroll-loops -floop-flatten
CFLAGS_MODULE   =
AFLAGS_MODULE   =
LDFLAGS_MODULE  =
